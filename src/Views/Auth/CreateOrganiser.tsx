    ...
    <div className="auth-form-step">
      ...
      <div className="form-group">
        <label htmlFor="fullname">
          ...
          <div
            className={`input-wrapper ${errors.fullname ? 'has-error' : ''}`}
          >
  ...
  const renderStep2 = () => (
    <div className="auth-form-step">
      ...
      <div
        ...
        role="group"
        aria-labelledby="industry-type-label"
      >
        <div
    ...
    <div className="auth-form-step">
      ...
      <div className="form-group">
        <label htmlFor="govtId">
          <span className="label-text">GOVT ID / DOCUMENT *</span>
          <div
            role="button"
            tabIndex={0}
            ...
            <input
              ...
              onChange={(e) => {
                if (e.target.files && e.target.files[0]) {
                  setValue('govtId', e.target.files[0], {
                    shouldValidate: true,
                  });
                }
              }}
            ...
            {!watch('govtId') ? (
              ...
              <div className="upload-preview">
                ...
                <button
                  ...
                  onClick={(e) => {
                    e.stopPropagation();
                    setValue('govtId', null as unknown as File, {
                      shouldValidate: true,
                    });
