...
import { Search, Filter, ArrowUpDown, Calendar, Clock, Users, Edit3, Send, Trash2, EyeOff } from 'lucide-react';
import { useNavigate } from 'react-router-dom';
import './GalaList.scss';
import { HeaderActions, useHeader } from '../../Shared/Context/HeaderContext';

const GalaList: React.FC = () => {
  ...
  const galas = [
    {
      ...
      description: 'The biggest entrepreneurial event of the year. Network with industry leaders...',
      date: 'June 20, 2024',
      time: '6:30 PM',
      applied: 0,
      status: 'Draft',
    ...
    },
    {
      ...
      description: 'Join our annual spring celebration with awards and performances',
      date: 'March 15, 2024',
      time: '7:00 PM',
      applied: 142,
      status: 'Active',
      image: 'https://images.unsplash.com/photo-1540575861501-7cf05a4b125a?auto=format&fit=crop&q=80&w=300'
    },
    {
      id: 3,
      title: 'Gala Vision Montréal 2023',
      description: 'A look back at the achievements of our community in the past year.',
      date: 'Dec 10, 2023',
      time: '7:00 PM',
      applied: 320,
      status: 'Completed',
  ...
  return (
    <div className="gala-management-view">
      ...
      <HeaderActions>
        <button className="header-btn btn-primary" onClick={() => navigate('/galas/create')}>+ Create New Gala</button>
      </HeaderActions>
